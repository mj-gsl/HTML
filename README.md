To Access  FastAPI Application: After running the command, FastAPI will start, and you should see output indicating that your application is running. By default, 
